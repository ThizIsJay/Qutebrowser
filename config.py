# Qutebrowser Configuratie

# Standaard config van config-generate-py
...
c.aliases = {
        'key': "open -t https://app.keeweb.info",
        'q': "quit",
        'upd': "config-source",
        'r': "reload",
        'b': "back",
...
c.content.blocking.adblock.lists = [
        ...
        "https://raw.githubusercontent.com/ThizIsJay/misc/stable/hosts",
]
